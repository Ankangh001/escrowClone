                ...
                <div class="headerV2-container section-container">
                    <div class="headerV2-inner">
                        <button class="headerV2-menuBtn media--available@tablet" aria-label="Open Menu" data-header-menu-toggle>
                            <svg class="icon headerV2-menuBtn-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                <path d="M12 16c-.3 0-.5-.1-.7-.3l-6-6 1.4-1.4 5.3 5.3 5.3-5.3 1.4 1.4-6 6c-.2.2-.4.3-.7.3z" />
                            </svg>
                        </button>
                        <a href="index.php" class="headerV2-logo" title="Go to home page">
                            ...
                            <ul class="headerV2-primaryNav">
                                ...
                                <li role="tab" tabindex="0" class="headerV2-primaryNav-item" aria-controls="header-consumer-tab" id="header-consumer" data-header-nav-item>
                                    <span class="headerV2-primaryNav-title">
                                        ...
                                        <svg class="icon headerV2-primaryNav-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                            <path d="M12 16c-.3 0-.5-.1-.7-.3l-6-6 1.4-1.4 5.3 5.3 5.3-5.3 1.4 1.4-6 6c-.2.2-.4.3-.7.3z" />
                                        </svg>
                                    </span>
                                        ...
                                        <div class="headerV2-subnav-container">
                                            <ul class="headerV2-subnav-list">
                                                ...
                                                <li class="headerV2-subnav-item media--available@mobile">
                                                    <a href="login.php" class="headerV2-subnav-link" data-e2e-target="header-nav-help-mobile-login">
                                                        <h3 class="headerV2-subnav-title" style="font-size:20px;">Login</h3>
                                                    </a>
                                                </li>
                                                <li class="headerV2-subnav-item media--available@mobile">
                                                    <a href="signup.php" class="headerV2-subnav-link">
                                                        <h3 class="headerV2-subnav-title" style="font-size:20px;">Signup &#8594;</h3>
                                                    </a>
                                                </li>
                                                ...
                                                <div class='header-userControl' data-target='user-control'>
                                                    <ul class='header-nav-list'>
                                                        <li class="header-nav-item media--hidden@tablet">
                                                            <a class="btn btn--secondary" href="#" data-e2e-target="header-nav-start-transaction" data-tracking-section="header" data-tracking-subsection="create_transaction" data-tracking-name="start_transaction">Signout</a>
                                                        </li>
                                                        <li class='header-nav-item'>
                                                            <span class='header-userControl-inner'>
                                                                <a href='#' class='header-nav-tab header-nav-tab--user '>
                                                            ...
                                                            <div class='header-dropdown card media--hidden@tablet' data-target='user-menu'>
                                                                <div class='header-dropdown-content'>
                                                                    <div class='header-dropdown-content-icon'>
                                                                        <span class='avatar avatar--large avatar--light'>a</span>
                                                                    </div>
                                                                    <div class='header-dropdown-content-copy'>

                                                                        <span class='header-dropdown-userEmail'>ankanghosh010@gmail.com</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </li>
                            ...
                            <div class="headerV2-search media--hidden@mobile">
                                <form class="expandableSearch" data-target="searchOverlay-input">
                                    <label class="expandableSearch-label" for="expandable-search" data-target="field">
                                        <svg class="expandableSearch-icon" width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                            <defs>
                                                <path d="M15.5 14h-.79l-.28-.27A6.471 6.471 0 0 0 16 9.5 6.5 6.5 0 1 0 9.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z" id="search-use-a" />
                                            </defs>
                                            <use fill-rule="nonzero" xlink:href="https://www.escrow.com/#search-use-a" transform="translate(-3 -3)" />
                                        </svg>
                                    </label>
                                    ...
                                    <button class="expandableSearch-closeBtn" tabindex="-1" aria-label="Close search">
                                        <svg class="expandableSearch-closeIcon" width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M13.705 2.292c-.394-.39-1.032-.39-1.426 0l-4.302 4.3-4.238-4.24c-.39-.39-1.026-.39-1.415 0-.39.39-.39 1.03 0 1.42l4.24 4.23-4.27 4.27c-.393.39-.393 1.03 0 1.43.394.39 1.033.39 1.427 0l4.268-4.27 4.24 4.24c.39.39 1.025.39 1.415 0 .39-.39.39-1.03 0-1.42l-4.24-4.23 4.3-4.3c.393-.4.393-1.03 0-1.43z" fill-rule="evenodd" />
                                        </svg>
                                    </button>
                            ...
                            <ul class="headerV2-authNav">
                                ...
                                if (isset($_SESSION['logged_in']) && $_SESSION['logged_in'] == true) {
                                    ...
                                    echo "
                                        ...
                                        <ul class='header-nav-list'>
                                            <li class='header-nav-item media--hidden@tablet'>
                                                <a class='btn btn--secondary' href='logout.php' >Signout</a>
                                            </li>
                                            <li class='header-nav-item'>
                                                <span class='header-userControl-inner'>
                                                    <a href='#' class='header-nav-tab header-nav-tab--user '>
                                                        <span class='avatar'>$fullname[0]</span>
                                                    </a>
                                                </span>
                                    ...
                                    <a href='login.php' class='headerV2-authNav-link' data-e2e-target='header-nav-login'>
                                        <span class='headerV2-authNav-text' style='font-size:20px !important;'>Login</span>
                                    </a>
                                </li>
                                <li class='headerV2-authNav-item'>
                                    <a href='signup.php' class='headerV2-authNav-link' data-e2e-target='header-nav-signup'>
                                        <span class='headerV2-authNav-text' style='font-size:20px !important;'>Signup &#8594;</span>
                                    </a>
                                </li>
    ...
    <script>
        $(document).ready(function(){
            $(window).scroll(function(){
                ...
                if (scroll > 20) {
                    $(".headerV2").css("background" , "#fff");
                    $(".headerV2-primaryNav-text").css("color" , "#1c314f");
                    $(".headerV2-authNav-link").css("color" , "#1c314f");
                    
                   
                }

                else {
                    $(".headerV2").css("background" , "transparent"); 
                    $(".headerV2-primaryNav-text").css("color" , "#fff");
                    $(".headerV2-authNav-link").css("color" , "#fff");                 
