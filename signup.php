                       ...
                       <!-- signup form -->
                        <form class="defaultForm loginForm" action="register.php" method="post" >
                            <div class="signupLogin-header">
                                <h2 class="section-formHeading signupLogin-header-heading" data-related-name="signupLogin-title" role="heading">Sign up to Escrow.com</h2>
                            </div>
                            ...
                            <fieldset class="defaultForm-fieldSet">
                                <div class="field" data-target="field" data-field="email-address">
                                    <label class="field-label" for="field-email-address">
                                        <span data-target="field-label-email-address">Enter your Full Name</span>
                                    </label>
                                    <div class="field-input">
                                        <div class="field-prefix" style="padding: 4px 7px;">
                                        ...
                                        <input type="text" class="defaultInput" id="name" name="name" required />
                                ...
                                <div class="field       " data-target="field" data-field="email-address">
                                    <label class="field-label" for="field-email-address">
                                        <span data-target="field-label-email-address">Please enter your email address</span>
                                    </label>
                                    <div class="field-input">
                                        ...
                                        <input type="email" class="defaultInput" id="email" name="email" required />
                                ...
                                <div class="field" data-target="field" data-field="password">
                                    <label class="field-label" for="field-password">
                                        <span data-target="field-label-password">Please select a password</span>
                                    </label>
                                    <div class="field-input">
                                    <div class="field-prefix">
                                            <div class="field-prefix-wrapper">
                                        ...
                                        <input  type="password" class="defaultInput" id="password" name="password" required/>

                                    </div>
                                </div>
                                

                                <div class="signupForm-suggestion">
                                    <div data-component="signupForm-suggestion-list">
                                        <h3 class="signupForm-suggestion-title">Strong passwords have: </h3>
                                        <ul class="signupForm-suggestion-list">
                                            <li class="signupForm-suggestion-item">

                                                At least 7 characters</li>
                                            <li class="signupForm-suggestion-item">


                                                At least one UPPER case and one lower case character</li>
                                            <li class="signupForm-suggestion-item">

                                                At least one number or special character</li>
                                        </ul>
                                    </div>
                                </div>
                            </fieldset>
                            <button class="btn btn--secondary  signupLogin-btn" name="submit" type="submit" >Sign Up</button>
                            <div class="signupForm-agreement">
                                By registering you agree to Escrow.com's <a href="#">Terms of Using the Escrow Platform</a> and <a href="#">Privacy Policy</a>
                            </div>
                            <footer class="signupLogin-footer">
                                <button class="btn btn--link  signupLogin-footer-link" type="button">Already have an account? Log in
                                </button>
                            </footer>
                        </form>
